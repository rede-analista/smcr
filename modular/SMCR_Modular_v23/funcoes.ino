  ...
  if ((agora - check_acoes_mod_lasttime) > vU16_modulos_MTBS_Acoes) {
    for (uint8_t x=0; x<vU8_totPinos; x++) {
      if ((aU8_AcaoRede1[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[0][x]) {
        if (f_regModHist(aU8_AcaoRede1[0][x],aU16_Acao1[2][x], aU16_Acao1[5][x], aU8_Pinos_Status[0][x])) {
      ...
      if ((aU8_AcaoRede2[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[1][x]) {
        if (f_regModHist(aU8_AcaoRede2[0][x],aU16_Acao2[2][x], aU16_Acao2[5][x], aU8_Pinos_Status[0][x])) {
      ...
      if ((aU8_AcaoRede3[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[2][x]) {
        if (f_regModHist(aU8_AcaoRede3[0][x], aU16_Acao3[2][x], aU16_Acao3[5][x], aU8_Pinos_Status[0][x])) {
