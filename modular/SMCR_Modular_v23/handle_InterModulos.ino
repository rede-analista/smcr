...
void f_handle_InterModulos() {
  ...
  html += "<input type='text' name='MTBSREC' id='id_mtbsrec' maxlength='14' size='14' value='"+String(vU16_modulos_HandShake)+"'> 1000 a 65535 </label>";
  html += "<br>";
  ...
  html += "<input type='text' name='MTBSACOES' id='id_mtbsacoes' maxlength='14' size='14' value='"+String(vU16_modulos_MTBS_Acoes)+"'> 1000 a 65035 </label>";
  html += "<br><br>";
