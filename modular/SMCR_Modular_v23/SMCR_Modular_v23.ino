...
String aS8_PinosMenu[1][vI8_aU8_Pinos] = {"Pino","Tipo","pinMode()","XoR","Nível_Acionamento","Retenção","Tempo_Retenção"};
//--------------------------------------------------------------------
...
String aS8_AcoesMenu[1][vI8_aU16_Acao] = {"Pino_Origem","Pino_Destino","Ação","Tempo_ON","Tempo_OFF","Mask_Pino_Dest_Rem"};
String aS8_AcoesRedeMenu[1][vI8_aU8_AcaoRede] = {"Envia_Módulo","Envia_Telegram","Notif_Assist.","Envia_MqTT"};
...
String aU16_InterModMenu[1][vI8_aU16_InterMod] = {"ID-Pino_HandShake","Porta do Receptor"};
...
aU8_ControlMsgMod[0][x] = Confirmado enviao Receptor Acao1
aU8_ControlMsgMod[1][x] = Confirmado enviao Receptor Acao2
aU8_ControlMsgMod[2][x] = Confirmado enviao Receptor Acao3
--------------------------------------------------------------------
aU8_ControlMsgModHist[0][x] = Historico 1
aU8_ControlMsgModHist[0][x] = Historico 2
aU8_ControlMsgModHist[0][x] = Historico .
aU8_ControlMsgModHist[0][x] = Historico .
aU8_ControlMsgModHist[0][x] = Historico .
aU8_ControlMsgModHist[0][x] = Historico 52
*/
uint8_t aU8_ControlMsgMod[vI8_aU8_ControlMsg][vU8_totPinos] = {};
uint8_t aU8_ControlMsgModHist[vI8_aU8_ControlMsgHist][vU8_totPinos] = {};
/* -----------------------------------------------------------
...
//uint8_t aU16_InterMod[vI8_aU16_InterMod][vU8_totPinos];
...
aU8_Pinos_Status[Propriedade][Pino]
aU8_Pinos_Status[0][x] = Status/Valor
*/
uint8_t aU8_Pinos[vI8_aU8_Pinos][vU8_totPinos];
String aS8_Pinos[vI8_aS8_Pinos][vU8_totPinos];
uint8_t aU8_Pinos_Status[1][vU8_totPinos] = {};
...
aU8_Pinos[5][x] = Mask Pino Destino
--------------------------------------------------------------------
Usado para cadastro de acoes, eventos quando uma porta(pino) e acionada
