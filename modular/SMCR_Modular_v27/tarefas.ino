    ...
    if (aU8_Pinos[1][idx] != 254) {
      if (aU8_Pinos[0][idx] > 0) {
        if ( aU8_IgnoraPino[0][idx] < 1) {
          aU16_Pinos_Status[0][idx] = f_lePino(aU8_Pinos[1][idx],aU8_Pinos[3][idx],aU8_Pinos[0][idx]);
        }
        if ( aU8_Pinos[5][idx] && aU16_Pinos_Status[0][idx] ) {
...
aU16_Acao[2][x] = Acao 0=Nenhuma / 1=Liga / 2=Liga Delay / 3=Pisca / 4=Pulso / 5=Pulso Delay / 254=Remoto
  ...
  for (;;){
    switch (aU16_Acao1[2][idz]) {
      ...
      case 254: //Atualiza Status para pino Remoto
        if (aU16_Acao1[0][idz] > 0 && aU16_Acao1[1][idz] > 0) {
          if (aU16_Pinos_Status[0][idz]) {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao1[1][idz])] = aU8_Pinos[4][f_retornaIndicePino(aU16_Acao1[1][idz])];
          } else {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao1[1][idz])] = !aU8_Pinos[4][f_retornaIndicePino(aU16_Acao1[1][idz])];
          }
        }
  ...
  for (;;){
    switch (aU16_Acao2[2][idz]) {
      ...
      case 254: //Atualiza Status para pino Remoto
        if (aU16_Acao2[0][idz] > 0 && aU16_Acao2[1][idz] > 0) {
          if (aU16_Pinos_Status[0][idz]) {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao2[1][idz])] = aU8_Pinos[4][f_retornaIndicePino(aU16_Acao2[1][idz])];
          } else {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao2[1][idz])] = !aU8_Pinos[4][f_retornaIndicePino(aU16_Acao2[1][idz])];
          }
        }
  ...
  for (;;){
    switch (aU16_Acao3[2][idz]) {
      ...
      case 254: //Atualiza Status para pino Remoto
        if (aU16_Acao3[0][idz] > 0 && aU16_Acao3[1][idz] > 0) {
          if (aU16_Pinos_Status[0][idz]) {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao3[1][idz])] = aU8_Pinos[4][f_retornaIndicePino(aU16_Acao3[1][idz])];
          } else {
            aU16_Pinos_Status[0][f_retornaIndicePino(aU16_Acao3[1][idz])] = !aU8_Pinos[4][f_retornaIndicePino(aU16_Acao3[1][idz])];
          }
        }
