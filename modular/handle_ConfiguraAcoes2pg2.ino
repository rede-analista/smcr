...
void f_handle_ConfiguraAcoes2pg2() {
  ...
  html += "<div id='mensagens'><p>Insira as informações de configuração das Ações Pg 4. e em seguida clique em \"Aplicar\".</p></div>";
  ...
  html += "<form action='/acoes2pg2' method='POST' style='margin:5px'>";
    html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar Pg4(sem salvar)' id='id_salvar'><br>";
  ...
  html += "</table>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar Pg4(sem salvar)' id='id_salvar'>";
  html += "</form>";
  html += "</div>";
