...
html += "<div id='mensagens'><p>Insira as informações de configuração das 3ª Ação(pinos 1 a "+String((vU8_totPinos/2))+"). e em seguida clique em \"Aplicar\".</p></div>";
  ...
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar Pg5(sem salvar)' id='id_salvar'><br>";
  ...
  html += "</table>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar Pg5(sem salvar)' id='id_salvar'>";
  html += "</form>";
  html += "</div>";
