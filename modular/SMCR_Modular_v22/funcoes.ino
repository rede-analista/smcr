...
void f_importarDoBackup() {
 ...
 // Atribuir valores aos arrays
  ...
  for (int i = 0; i < vI8_aU8_InterMod; i++) {
    for (int j = 0; j < vU8_totPinos; j++) {
      aU8_InterMod[i][j] = doc["aU8_InterMod"][i][j];
    }
  }
  ...
  for (int i = 0; i < vI8_aU16_AcaoRede; i++) {
    for (int j = 0; j < vU8_totPinos; j++) {
      aU16_AcaoRede1[i][j] = doc["aU16_AcaoRede1"][i][j].as<uint16_t>();
    }
  }
  ...
  for (int i = 0; i < vI8_aU16_AcaoRede; i++) {
    for (int j = 0; j < vU8_totPinos; j++) {
      aU16_AcaoRede2[i][j] = doc["aU16_AcaoRede2"][i][j].as<uint16_t>();
    }
  }
  ...
  for (int i = 0; i < vI8_aU16_AcaoRede; i++) {
    for (int j = 0; j < vU8_totPinos; j++) {
      aU16_AcaoRede3[i][j] = doc["aU16_AcaoRede3"][i][j].as<uint16_t>();
    }
  }
...
String f_exportarParaBackup() {
  ...
  DynamicJsonDocument doc(JSON_OBJECT_SIZE(1) +
                          JSON_OBJECT_SIZE(36) +  // número de variáveis não array
                          vI8_aS_InterMod * JSON_ARRAY_SIZE(vU8_totPinos) +
                          vI8_aU8_InterMod * JSON_ARRAY_SIZE(vU8_totPinos) +
  ...
  serializeArray(aU8_InterMod, "aU8_InterMod", vI8_aU8_InterMod, vU8_totPinos, docExport);
  ...
  serializeArray(aU16_AcaoRede1, "aU16_AcaoRede1", vI8_aU16_AcaoRede, vU8_totPinos, docExport);
  ...
  serializeArray(aU16_AcaoRede2, "aU16_AcaoRede2", vI8_aU16_AcaoRede, vU8_totPinos, docExport);
  ...
  serializeArray(aU16_AcaoRede3, "aU16_AcaoRede3", vI8_aU16_AcaoRede, vU8_totPinos, docExport);
...
void f_iniciaInterModulos() {
  ...
  uint8_t aU8Buffer[vI8_aU8_InterMod][vU8_totPinos];  

  CONFIG_FLASH.getBytes("paS_InterMod", aSBuffer, CONFIG_FLASH.getBytesLength("paS_InterMod"));
  CONFIG_FLASH.getBytes("paU8_InterMod", aU8Buffer, CONFIG_FLASH.getBytesLength("paU8_InterMod"));
  CONFIG_FLASH.end();
  ...
  for (uint8_t x=0; x<vI8_aU8_InterMod; x++){
    for (uint8_t y=0; y<vU8_totPinos; y++) {
      aU8_InterMod[x][y] = aU8Buffer[x][y];
    }
  }
  for (uint8_t y=0; y<vU8_totPinos; y++) {
...
void f_checkAcoesModulos() {
  ...
  if ((agora - check_acoes_mod_lasttime) > vU16_modulos_MTBS) {
    for (uint8_t x=0; x<vU8_totPinos; x++) {
      if ((aU16_AcaoRede1[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[0][x]) {
        if (f_enviaModulo(aU16_AcaoRede1[0][x],String(aU16_Acao1[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
        //if (f_enviaModulo(aU16_AcaoRede1[0][x],String(aU16_Acao1[2][x]), String(aU8_Pinos[0][x]), String(aU8_Pinos_Status[0][x])) == 200) {  
          aU8_ControlMsgMod[0][x] = 1;
        }
      } else if ((aU16_AcaoRede1[0][x] >0 ) && !aU8_Pinos_Status[0][x] && aU8_ControlMsgMod[0][x]){
        if (f_enviaModulo(aU16_AcaoRede1[0][x],String(aU16_Acao1[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
        //if (f_enviaModulo(aU16_AcaoRede1[0][x],String(aU16_Acao1[2][x]), String(aU8_Pinos[0][x]), String(aU8_Pinos_Status[0][x])) == 200) {  
          aU8_ControlMsgMod[0][x] = 0;
        }
      }
      if ((aU16_AcaoRede2[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[1][x]) {
        if (f_enviaModulo(aU16_AcaoRede2[0][x],String(aU16_Acao2[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
          aU8_ControlMsgMod[1][x] = 1;
        }
      } else if ((aU16_AcaoRede2[0][x] >0 ) && !aU8_Pinos_Status[0][x] && aU8_ControlMsgMod[1][x]){
        if (f_enviaModulo(aU16_AcaoRede2[0][x],String(aU16_Acao2[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
          aU8_ControlMsgMod[1][x] = 0;
        }
      }
      if ((aU16_AcaoRede3[0][x] >0 ) && aU8_Pinos_Status[0][x] && !aU8_ControlMsgMod[2][x]) {
        if (f_enviaModulo(aU16_AcaoRede3[0][x],String(aU16_Acao3[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
          aU8_ControlMsgMod[2][x] = 1;
        }
      } else if ((aU16_AcaoRede3[0][x] >0 ) && !aU8_Pinos_Status[0][x] && aU8_ControlMsgMod[2][x]){
        if (f_enviaModulo(aU16_AcaoRede3[0][x],String(aU16_Acao3[2][x]), String(aU16_Acao1[5][x]), String(aU8_Pinos_Status[0][x])) == 200) {
...
*/
  for (uint8_t y=0; y<vU8_totPinos; y++) {
    ...
    if (aU8_InterMod[1][y] == 1) {
      if (aU16_ControlHS[0][y] < 2 && aU8_InterMod[0][y] > 0) { 
        //Serial.print("SEND HS Modulo:");
        //Serial.print(aS_InterMod[0][y]);
        //Serial.print(" IP:");
        //Serial.print(f_retornaIpModulo(aU8_InterMod[0][y]));
        //Serial.print(" Pino:");
        //Serial.print(aU8_InterMod[0][y]);
        //Serial.print(" da Origem Pino ID:");
        //Serial.print(f_retornaIndicePino(aU8_InterMod[0][f_retornaIndiceHS(vS_nomeDispositivo)]));
        //Serial.print(" Status:");
        //Serial.println(aU16_ControlHS[1][y]);        
        if (f_enviaModulo(aU8_InterMod[0][y],"255", String(aU8_InterMod[0][f_retornaIndiceHS(vS_nomeDispositivo)]), "0") == 200) {
          aU16_ControlHS[0][y] = vI_cicloHandshake;
    ...
    aU8_Pinos_Status[0][f_retornaIndicePino(aU8_InterMod[0][y])] = aU16_ControlHS[1][y];
  }
}
...
int f_enviaModulo(uint8_t idmodulo, String acao, String pino, String valor){
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    GET_SERVIDOR = "http://" + f_retornaIpModulo(idmodulo) + ":" + vU16_portaWebModulos + "/dados?pl=" + vS_nomeDispositivo + "&ac=" + acao + "&pn=" + pino + "&vl=" + valor; //aS_InterMod[1][idmodulo]
...
bool f_checkAcoesAssistentes() {
  ...
  if ((agora - check_acoes_ass_lasttime) > vU16_ass_MTBS) {
    for (uint8_t x=0; x<vU8_totPinos; x++) {
      if (aU16_AcaoRede1[2][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgAss[0][x]) {
      ...
      } else if(aU16_AcaoRede1[2][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgAss[0][x]){
      ...
      if (aU16_AcaoRede2[2][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgAss[1][x]) {
      ...
      } else if(aU16_AcaoRede2[2][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgAss[1][x]){
      ...
      if (aU16_AcaoRede3[2][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgAss[2][x]) {
      ...
      } else if(aU16_AcaoRede3[2][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgAss[2][x]){
...
bool f_checkAcoesTelegram() {
  ...
  if ((agora - check_acoes_telegram_lasttime) > vU16_bot_MTBS) {
    for (uint8_t x=0; x<vU8_totPinos; x++) {
      if (aU16_AcaoRede1[1][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgTelegram[0][x]) {
      ...
      } else if(aU16_AcaoRede1[1][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgTelegram[0][x]){
        resultado = f_enviaTelegram(vS_nomeDispositivo+"\n"+aS8_Pinos[0][x]+" - Normalização AÇÃO: "+f_traduzAcoesTelegram(aU16_Acao1[2][x])+"\n Origem: "+String(aU16_Acao1[0][x])+" Destino: "+aU16_Acao1[1][x]);
        aU8_ControlMsgTelegram[0][x] = 0;
      }
      if (aU16_AcaoRede2[1][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgTelegram[1][x]) {
      ...
      } else if(aU16_AcaoRede2[1][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgTelegram[1][x]){
        resultado = f_enviaTelegram(vS_nomeDispositivo+"\n"+aS8_Pinos[0][x]+" - Normalização AÇÃO 2: "+f_traduzAcoesTelegram(aU16_Acao2[2][x])+"\n Origem: "+String(aU16_Acao2[0][x])+" Destino: "+aU16_Acao2[1][x]);
        aU8_ControlMsgTelegram[1][x] = 0;
      }
      if (aU16_AcaoRede3[1][x] && aU8_Pinos_Status[0][x] && !aU8_ControlMsgTelegram[2][x]) {
      ...
      } else if(aU16_AcaoRede3[1][x] && !aU8_Pinos_Status[0][x] && aU8_ControlMsgTelegram[2][x]){
...
void f_salvaFlash() {
  ...
  Serial.print("Tamanho paU16_AcaoRede3 em bytes: ");
  Serial.println( CONFIG_FLASH.getBytesLength("paU16_AcaoRede3") );
  ...
  Serial.print("Numero de elementos aU8_InterMod: ");
  Serial.println(sizeof(aU8_InterMod) / sizeof(uint8_t));
  Serial.print("Tamanho aU8_InterMod em bytes: ");
  Serial.println( sizeof(aU8_InterMod) );
  CONFIG_FLASH.putBytes( "paU8_InterMod", aU8_InterMod, sizeof(aU8_InterMod) );
  Serial.print("Tamanho paU8_InterMod em bytes: ");
  Serial.println( CONFIG_FLASH.getBytesLength("paU8_InterMod"));
