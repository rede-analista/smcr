...
String aS8_PinosMenu[1][vI8_aU8_Pinos] = {"Pino","Tipo","Modo","XoR","Nível_Acionamento","Retenção","Tempo_Retenção"};
//--------------------------------------------------------------------
...
String aS8_AcoesMenu[1][vI8_aU16_Acao] = {"Pino_Origem","Pino_Destino","Ação","Tempo_ON","Tempo_OFF","Pino_Destino_Remoto"};
