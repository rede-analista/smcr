...
uint16_t vU16_portaWeb, vU16_bot_MTBS, vU16_mqttPorta, vU16_mqtt_MTBS, vU16_ass_MTBS, vU16_modulos_MTBS; //vU16_portaWebModulos
...
//--------------------------------------------------------------------
uint64_t hora_lasttime, mqtt_lasttime, telegram_lasttime, check_acoes_telegram_lasttime, check_acoes_mqtt_lasttime, discovery_mqtt_lasttime, check_acoes_ass_lasttime, check_acoes_mod_lasttime;
#define ESP32
...
aU8_Pinos[4][x] = Acionamento Alto=1 / Baixo=0
--------------------------------------------------------------------
Usado para cadastro de acoes, eventos quando uma porta(pino) e acionada
