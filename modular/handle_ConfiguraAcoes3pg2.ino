...
void f_handle_ConfiguraAcoes3pg2() {
  ...
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 3ª Ação Pg2(sem salvar)' id='id_salvar'>";
  ...
  html += "</table>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 3ª Ação Pg2(sem salvar)' id='id_salvar'><br>";
  html += "</form>";
  html += "</div>";
