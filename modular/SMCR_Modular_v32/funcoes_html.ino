...
void f_limpaFLASH() {
  ...
  if (SERVIDOR_WEB.arg("SUBMIT_SALVAR").length() > 0) {
    if (SERVIDOR_WEB.arg("FLASH") == "Tudo") {
      ...
      CONFIG_FLASH.remove("nome_wifi_ap");
      CONFIG_FLASH.remove("senha_wifi_ap");
      CONFIG_FLASH.remove("modo_wifi_ap");
      CONFIG_FLASH.remove("ntp_srv1");
      CONFIG_FLASH.remove("ntp_srv2");
      CONFIG_FLASH.remove("ntp_timez");
      CONFIG_FLASH.remove("cor_sts_1");
      CONFIG_FLASH.remove("cor_sts_0");
      ...
      CONFIG_FLASH.remove("time_mod_ac");
      CONFIG_FLASH.remove("ciclo_mod");
      CONFIG_FLASH.remove("qnt_pinos");
