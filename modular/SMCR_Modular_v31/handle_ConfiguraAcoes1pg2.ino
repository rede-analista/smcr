//========================================
void f_handle_ConfiguraAcoes1pg2() {
  String html;
  ...
  html += "<form action='/acoes1pg2' method='POST' style='margin:5px'>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 1ª Ação Pg2(sem salvar)' id='id_salvar'>";
  ...
  html += "</table>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 1ª Ação Pg2(sem salvar)' id='id_salvar'><br>";
  html += "</form>";
  html += "</div>";
  Serial.println("Aguardando informacoes... f_handle_ConfiguraAcoes1pg2");
