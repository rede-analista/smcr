...
void f_handle_ConfiguraAcoes2pg1() {
  ...
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 2ª Ação Pg1(sem salvar)' id='id_salvar'>";
  ...
  html += "</table>";
  html += "<input type='submit' name='SUBMIT_SALVAR' value='Aplicar 2ª Ação Pg1(sem salvar)' id='id_salvar'><br>";
  html += "</form>";
  html += "</div>";
