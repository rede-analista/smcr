    ...
    if (f_retornaModulo(SERVIDOR_WEB.arg(0)) < vU8_totPinos) {
      ...
      switch (SERVIDOR_WEB.arg(1).toInt()) {
        ...
        case 255: // Parametro acao = 255(sincronismo)
          ...
          aU16_Pinos_Status[0][f_retornaIndicePino(SERVIDOR_WEB.arg(2).toInt())] = aU16_ControlHS[1][f_retornaIndiceHS(SERVIDOR_WEB.arg(0))];
          validacao = "OK_DADO_RECEBIDO";
          break;
        default:
          aU16_ControlHS[0][f_retornaIndiceHS(SERVIDOR_WEB.arg(0))] = vI_cicloHandshake;
...
void f_checkHandShake() {
  ...
  if ((agora - check_mod_lasttime) > vU16_modulos_HandShake) {
    for (uint8_t y=0; y<vU8_totPinos; y++) {
      ...
      aU16_Pinos_Status[0][f_retornaIndicePino(aU16_InterMod[0][y])] = aU16_ControlHS[1][y];
    }
